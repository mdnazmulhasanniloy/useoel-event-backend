...
exports.robomissionService = void 0;
const http_status_1 = __importDefault(require("http-status"));
const robomission_models_1 = __importDefault(require("./robomission.models"));
...
const createRobomission = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (event.category !== events_constants_1.CATEGORY_NAME.roboMission) {
            throw new AppError_1.default(http_status_1.default.FORBIDDEN, 'This event is not a Robomission event');
        }
        // Create FutureInnovators
        const result = yield robomission_models_1.default.create([gameData], { session });
        if (!result || result.length === 0) {
            throw new AppError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to create Robomission');
        }
        // Prepare rounds data
        //@ts-ignore
        const roundsArr = rounds
            ? yield Promise.all(rounds.map((round) => __awaiter(void 0, void 0, void 0, function* () {
                return (Object.assign(Object.assign({}, round), { gameType: rounds_interface_1.gameType.robomission, 
                    //@ts-ignore
                    game: result[0]._id }));
            })))
            : [];
...
const getAllRobomission = (query) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
                                ...
                                $match: {
                                    $expr: {
                                        $and: [
                                            ...
                                            { $eq: ['$gameType', rounds_interface_1.gameType.robomission] },
                                        ],
                                    },
                                },
                            },
    ...
    const [result] = yield robomission_models_1.default.aggregate(pipeline);
...
const getRobomissionById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const [result] = yield robomission_models_1.default.aggregate([
        {
    ...
    if (!result) {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, 'Robomission not found!');
    }
    return result;
});
const updateRobomission = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield robomission_models_1.default.findByIdAndUpdate(id, payload, {
        new: true,
    });
    if (!result || result.isDeleted) {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to update Robomission');
    }
    return result;
});
const deleteRobomission = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield robomission_models_1.default.findByIdAndUpdate(id, { isDeleted: true }, { new: true });
    if (!result) {
        throw new AppError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to delete robomission');
    }
    return result;
});
exports.robomissionService = {
    createRobomission,
    getAllRobomission,
    getRobomissionById,
    updateRobomission,
